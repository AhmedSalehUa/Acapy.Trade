...
import screens.members.assets.SalesSolfa;
 ...
 */
public class SalesScreenSolfaController implements Initializable {

    @FXML
    private JFXTextField search;
    @FXML
    private TableView<SalesSolfa> tab;
    @FXML
    private TableColumn<SalesSolfa, String> tabaccount;
    @FXML
    private TableColumn<SalesSolfa, String> tabdate;
    @FXML
    private TableColumn<SalesSolfa, String> tabamount;
    @FXML
    private TableColumn<SalesSolfa, String> tabid;
    @FXML
    private Label id;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tab.setOnMouseClicked((e) -> {
            if (tab.getSelectionModel().getSelectedIndex() == -1) {
                ...
                SalesSolfa selected = tab.getSelectionModel().getSelectedItem();
    ...
    void getData(int id) {
        progress.setVisible(true);
        Service<Void> service = new Service<Void>() {
            ObservableList<SalesSolfa> data;
    ...
    ObservableList<SalesSolfa> items;

    @FXML
    private void search(KeyEvent event) {
        FilteredList<SalesSolfa> filteredData = new FilteredList<>(items, p -> true);
        ...
        SortedList< SalesSolfa> sortedData = new SortedList<>(filteredData);
        sortedData.comparatorProperty().bind(tab.comparatorProperty());
        tab.setItems(sortedData);
    }
    SalesSolfa opd = new SalesSolfa();
