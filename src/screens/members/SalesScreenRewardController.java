...
import screens.members.assets.SalesReward;
 ...
 */
public class SalesScreenRewardController implements Initializable {

    @FXML
    private JFXTextField search;
    @FXML
    private TableView<SalesReward> tab;
    @FXML
    private TableColumn<SalesReward, String> tabaccount;
    @FXML
    private TableColumn<SalesReward, String> tabdate;
    @FXML
    private TableColumn<SalesReward, String> tabamount;
    @FXML
    private TableColumn<SalesReward, String> taboperation;
    @FXML
    private TableColumn<SalesReward, String> tabid;
    @FXML
    private Label id;
    @FXML
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        tab.setOnMouseClicked((e) -> {
            if (tab.getSelectionModel().getSelectedIndex() == -1) {
                ...
                SalesReward selected = tab.getSelectionModel().getSelectedItem();
    ...
    void getData(int id) {
        progress.setVisible(true);
        Service<Void> service = new Service<Void>() {
            ObservableList<SalesReward> data;
    ...
    ObservableList<SalesReward> items;

    @FXML
    private void search(KeyEvent event) {
        FilteredList<SalesReward> filteredData = new FilteredList<>(items, p -> true);
        ...
        SortedList< SalesReward> sortedData = new SortedList<>(filteredData);
        sortedData.comparatorProperty().bind(tab.comparatorProperty());
        tab.setItems(sortedData);
    }
    SalesReward opd = new SalesReward();
