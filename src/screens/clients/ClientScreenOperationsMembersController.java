 ...
 * @author AHMED
 */
public class ClientScreenOperationsMembersController implements Initializable {
    ...
    private Button Add;
    int OPERATION_ID = 0;
    ClientScreenOperationsController parentConrol;
...
//                }
    ...
    void setParentController(ClientScreenOperationsController parentConrol) {
