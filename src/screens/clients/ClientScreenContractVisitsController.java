...
public class ClientScreenContractVisitsController implements Initializable {
            ...
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    ...
                    protected Void call() throws Exception {
                        ...
                        try {
                            data = ContractVisits.getData(id);
    ...
    private void fillCombo() {progress.setVisible(true); 
        Service<Void> service = new Service<Void>() { ObservableList<AcapyMembers> data;
            @Override
            protected Task<Void> createTask() {
                return new Task<Void>() {
                    @Override
