...
public class maintaince {
    ...
    public maintaince(int id,String client_name,String member_name,   String date  , String problem, int cost,   String pay_type) {
        this.id = id;
     ...
     public boolean Edit() throws Exception {
      ...
      public boolean Delete() throws Exception {
       ...
       public static ObservableList<maintaince> getData() throws Exception {
        ...
        while (rs.next()) {
            data.add(new maintaince (rs.getInt(1), rs.getString(2), rs.getString(3) , rs.getString(4),rs.getString(5), rs.getInt(6), rs.getString(7)));
        }
        return data;
    }
